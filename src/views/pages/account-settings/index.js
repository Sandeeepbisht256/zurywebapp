...
import ListfoodTabContent from './ListfoodTabContent'
...
const AccountSettings = () => {
  ...
  return (
    <Fragment>
      <Breadcrumbs breadCrumbTitle='User details' breadCrumbParent='Pages' breadCrumbActive='Account Settings' />
      {data !== null ? (
        <Row>
            ...
            <Card>
              <CardBody>
                <TabContent activeTab={activeTab}>
                  ...
                  <TabPane tabId='6'>
                    <CustomerTabContent data={data.Customer} />
                  </TabPane>
                  <TabPane tabId='7'>
                    <DietTabContent data={data.Diet} />
                  </TabPane>
                  <TabPane tabId='8'>
                    <ListfoodTabContent data={data.Listfood} />
                  </TabPane>
                </TabContent>
              </CardBody>
            </Card>
